...
before you run the code you have to also make sure that you have a connected camera. Inside the code you have to choose  the source of stream let  0 for your pc camera and 1 ..2..3.. for any other sources . you can actually provide an already saved video in the capture by given the path as a parameter.
